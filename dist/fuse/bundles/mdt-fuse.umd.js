(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/flex-layout/core'), require('@angular/cdk/platform'), require('perfect-scrollbar'), require('moment'), require('@angular/common/http'), require('prismjs/prism'), require('prismjs/components/prism-bash'), require('prismjs/components/prism-c'), require('prismjs/components/prism-cpp'), require('prismjs/components/prism-csharp'), require('prismjs/components/prism-css'), require('prismjs/components/prism-diff'), require('prismjs/components/prism-markup'), require('prismjs/components/prism-markup-templating'), require('prismjs/components/prism-java'), require('prismjs/components/prism-javascript'), require('prismjs/components/prism-json'), require('prismjs/components/prism-perl'), require('prismjs/components/prism-php'), require('prismjs/components/prism-python'), require('prismjs/components/prism-sass'), require('prismjs/components/prism-scss'), require('prismjs/components/prism-typescript'), require('lodash'), require('ngx-cookie-service'), require('@angular/flex-layout'), require('@angular/material'), require('@angular/forms'), require('rxjs'), require('@ngx-translate/core'), require('@angular/common'), require('@angular/animations'), require('@angular/router'), require('rxjs/operators'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@mdt/fuse', ['exports', '@angular/flex-layout/core', '@angular/cdk/platform', 'perfect-scrollbar', 'moment', '@angular/common/http', 'prismjs/prism', 'prismjs/components/prism-bash', 'prismjs/components/prism-c', 'prismjs/components/prism-cpp', 'prismjs/components/prism-csharp', 'prismjs/components/prism-css', 'prismjs/components/prism-diff', 'prismjs/components/prism-markup', 'prismjs/components/prism-markup-templating', 'prismjs/components/prism-java', 'prismjs/components/prism-javascript', 'prismjs/components/prism-json', 'prismjs/components/prism-perl', 'prismjs/components/prism-php', 'prismjs/components/prism-python', 'prismjs/components/prism-sass', 'prismjs/components/prism-scss', 'prismjs/components/prism-typescript', 'lodash', 'ngx-cookie-service', '@angular/flex-layout', '@angular/material', '@angular/forms', 'rxjs', '@ngx-translate/core', '@angular/common', '@angular/animations', '@angular/router', 'rxjs/operators', '@angular/core'], factory) :
    (factory((global.mdt = global.mdt || {}, global.mdt.fuse = {}),global.ng['flex-layout'].core,global.ng.cdk.platform,global.PerfectScrollbar,global.moment_,global.ng.common.http,global.Prism,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,global._,global.ngxCookieService,global.ng['flex-layout'],global.ng.material,global.ng.forms,global.rxjs,global.i1$2,global.ng.common,global.ng.animations,global.ng.router,global.rxjs.operators,global.ng.core));
}(this, (function (exports,i1,i1$1,PerfectScrollbar,moment_,http,Prism,prismBash,prismC,prismCpp,prismCsharp,prismCss,prismDiff,prismMarkup,prismMarkupTemplating,prismJava,prismJavascript,prismJson,prismPerl,prismPhp,prismPython,prismSass,prismScss,prismTypescript,_,ngxCookieService,flexLayout,material,forms,rxjs,i1$2,i2,i1$3,i1$4,operators,i0) { 'use strict';
    ...
    var FUSE_CONFIG = new i0.InjectionToken('fuseCustomConfig');
    var FuseConfigService = /** @class */ (function () {
        ...
        FuseConfigService.prototype._init = function () {
            ...
            this._configSubject = new rxjs.BehaviorSubject(_.cloneDeep(this._defaultConfig));
            // Reload the default layout config on every RoutesRecognized event
            // if the current layout config is different from the default one
            this._router.events
                .pipe(operators.filter(function (event) { return event instanceof i1$4.ResolveEnd; }))
                .subscribe(function () {
        ...
        /** @nocollapse */
        FuseConfigService.ctorParameters = function () {
            return [
                { type: i1$1.Platform },
                { type: i1$4.Router },
                { type: undefined, decorators: [{ type: i0.Inject, args: [FUSE_CONFIG,] }] }
            ];
        };
        FuseConfigService.ngInjectableDef = i0.defineInjectable({ factory: function FuseConfigService_Factory() { return new FuseConfigService(i0.inject(i1$1.Platform), i0.inject(i1$4.Router), i0.inject(FUSE_CONFIG)); }, token: FuseConfigService, providedIn: "root" });
    ...
    var FuseModule = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseModule.ctorParameters = function () {
            return [
                { type: FuseModule, decorators: [{ type: i0.Optional }, { type: i0.SkipSelf }] }
            ];
        };
        return FuseModule;
    }());
    ...
    var FuseIfOnDomDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseIfOnDomDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: i0.TemplateRef },
    ...
    var FuseMatchMediaService = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseMatchMediaService.ctorParameters = function () {
            return [
    ...
    var FuseInnerScrollDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseInnerScrollDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
    ...
    ***************************************************************************** */
    ...
    var FusePerfectScrollbarDirective = /** @class */ (function () {
        ...
        FusePerfectScrollbarDirective.prototype.ngAfterViewInit = function () {
            ...
            if (this.fusePerfectScrollbarOptions.updateOnRouteChange) {
                this._router.events
                    .pipe(operators.takeUntil(this._unsubscribeAll), operators.filter(function (event) { return event instanceof i1$4.NavigationEnd; }))
                    .subscribe(function () {
                    setTimeout(function () {
                        _this.scrollToTop();
                        _this.update();
        ...
        /** @nocollapse */
        FusePerfectScrollbarDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
        ...
        FusePerfectScrollbarDirective.propDecorators = {
            fusePerfectScrollbarOptions: [{ type: i0.Input }],
            enabled: [{ type: i0.Input, args: ['fusePerfectScrollbar',] }],
            _updateOnResize: [{ type: i0.HostListener, args: ['window:resize',] }],
    ...
    var FuseMatSidenavHelperDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseMatSidenavHelperDirective.ctorParameters = function () {
            return [
                { type: FuseMatchMediaService },
        ...
        FuseMatSidenavHelperDirective.propDecorators = {
            isLockedOpen: [{ type: i0.HostBinding, args: ['class.mat-is-locked-open',] }],
            fuseMatSidenavHelper: [{ type: i0.Input }],
            matIsLockedOpen: [{ type: i0.Input }]
        };
    ...
    var FuseMatSidenavTogglerDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseMatSidenavTogglerDirective.ctorParameters = function () {
            return [
                { type: FuseMatSidenavHelperService }
            ];
        };
        FuseMatSidenavTogglerDirective.propDecorators = {
            fuseMatSidenavToggler: [{ type: i0.Input }],
    ...
    var HtmlToPlaintextPipe = /** @class */ (function () {
        ...
        HtmlToPlaintextPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'htmlToPlaintext' },] }
        ];
    ...
    var CamelCaseToDashPipe = /** @class */ (function () {
        ...
        CamelCaseToDashPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'camelCaseToDash' },] }
        ];
    ...
    var customAnimation = i1$3.animation([
        i1$3.style({
            opacity: '{{opacity}}',
            transform: 'scale({{scale}}) translate3d({{x}}, {{y}}, {{z}})'
        }),
        i1$3.animate('{{duration}} {{delay}} cubic-bezier(0.0, 0.0, 0.2, 1)', i1$3.style('*'))
    ], {
        params: {
            duration: '200ms',
            delay: '0ms',
    ...
    var fuseAnimations = [
        i1$3.trigger('animate', [i1$3.transition('void => *', [i1$3.useAnimation(customAnimation)])]),
        i1$3.trigger('animateStagger', [
            i1$3.state('50', i1$3.style('*')),
            i1$3.state('100', i1$3.style('*')),
            i1$3.state('200', i1$3.style('*')),
            i1$3.transition('void => 50', i1$3.query('@*', [
                i1$3.stagger('50ms', [
                    i1$3.animateChild()
                ])
            ], { optional: true })),
            i1$3.transition('void => 100', i1$3.query('@*', [
                i1$3.stagger('100ms', [
                    i1$3.animateChild()
                ])
            ], { optional: true })),
            i1$3.transition('void => 200', i1$3.query('@*', [
                i1$3.stagger('200ms', [
                    i1$3.animateChild()
                ])
            ], { optional: true }))
        ]),
        i1$3.trigger('fadeInOut', [
            i1$3.state('0', i1$3.style({
                display: 'none',
                opacity: 0
            })),
            i1$3.state('1', i1$3.style({
                display: 'block',
                opacity: 1
            })),
            i1$3.transition('1 => 0', i1$3.animate('300ms ease-out')),
            i1$3.transition('0 => 1', i1$3.animate('300ms ease-in'))
        ]),
        i1$3.trigger('slideInOut', [
            i1$3.state('0', i1$3.style({
                height: '0px',
                display: 'none'
            })),
        ...
        i1$3.trigger('slideIn', [
            i1$3.transition('void => left', [
                i1$3.style({
                    transform: 'translateX(100%)'
                }),
                i1$3.animate('300ms ease-in', i1$3.style({
                    transform: 'translateX(0)'
                }))
            ]),
            i1$3.transition('left => void', [
                i1$3.style({
                    transform: 'translateX(0)'
                }),
                i1$3.animate('300ms ease-in', i1$3.style({
        ...
        i1$3.trigger('slideInLeft', [
            i1$3.state('void', i1$3.style({
                transform: 'translateX(-100%)',
                display: 'none'
            })),
            i1$3.state('*', i1$3.style({
                transform: 'translateX(0)',
                display: 'flex'
            })),
            i1$3.transition('void => *', i1$3.animate('300ms')),
            i1$3.transition('* => void', i1$3.animate('300ms'))
        ]),
        i1$3.trigger('slideInRight', [
            i1$3.state('void', i1$3.style({
                transform: 'translateX(100%)',
                display: 'none'
            })),
        ...
        i1$3.trigger('expandCollapse', [
            ...
            i1$3.transition('void => *', i1$3.animate('300ms ease-out')),
            i1$3.transition('* => void', i1$3.animate('300ms ease-in'))
        ]),
        // -----------------------------------------------------------------------------------------------------
        // @ Router animations
        // -----------------------------------------------------------------------------------------------------
        i1$3.trigger('routerTransitionLeft', [
            i1$3.transition('* => *', [
                i1$3.query('content > :enter, content > :leave', [
                    i1$3.style({
                        position: 'absolute',
                        top: 0,
                        bottom: 0,
                ...
                i1$3.sequence([
                    i1$3.group([
                        i1$3.query('content > :leave', [
                            i1$3.style({
                                transform: 'translateX(0)',
                                opacity: 1
                            }),
                            i1$3.animate('600ms cubic-bezier(0.0, 0.0, 0.2, 1)', i1$3.style({
                                transform: 'translateX(-100%)',
                                opacity: 0
                            }))
                        ], { optional: true }),
                        i1$3.query('content > :enter', [
                            i1$3.style({ transform: 'translateX(100%)' }),
                            i1$3.animate('600ms cubic-bezier(0.0, 0.0, 0.2, 1)', i1$3.style({
                                transform: 'translateX(0%)',
                                opacity: 1
                            }))
                    ...
                    i1$3.query('content > :leave', i1$3.animateChild(), { optional: true }),
                    i1$3.query('content > :enter', i1$3.animateChild(), { optional: true })
                ])
            ])
        ]),
        i1$3.trigger('routerTransitionRight', [
            i1$3.transition('* => *', [
                i1$3.query('content > :enter, content > :leave', [
                    i1$3.style({
                        position: 'absolute',
        ...
        i1$3.trigger('routerTransitionUp', [
            i1$3.transition('* => *', [
                i1$3.query('content > :enter, content > :leave', [
                    i1$3.style({
                        position: 'absolute',
                ...
                i1$3.group([
                    ...
                    i1$3.query('content > :enter', [
                        i1$3.style({ transform: 'translateY(100%)' }),
                        i1$3.animate('600ms cubic-bezier(0.0, 0.0, 0.2, 1)', i1$3.style({
                            transform: 'translateY(0%)',
                            opacity: 1
                        }))
        ...
        i1$3.trigger('routerTransitionDown', [
            i1$3.transition('* => *', [
                i1$3.query('content > :enter, content > :leave', [
                    i1$3.style({
                        position: 'absolute',
        ...
        i1$3.trigger('routerTransitionFade', [
            i1$3.transition('* => *', i1$3.group([
                i1$3.query('content > :enter, content > :leave ', [
                    i1$3.style({
                        position: 'absolute',
                        top: 0,
                ...
                i1$3.query('content > :leave', [
                    ...
                    i1$3.animate('300ms cubic-bezier(0.0, 0.0, 0.2, 1)', i1$3.style({
                        opacity: 0
                    }))
                ], { optional: true }),
                i1$3.query('content > :enter', [
    ...
    var FuseConfirmDialogComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseConfirmDialogComponent.ctorParameters = function () {
            return [
    ...
    var FuseCountdownComponent = /** @class */ (function () {
        ...
        FuseCountdownComponent.prototype.ngOnInit = function () {
            ...
            var countDown = rxjs.interval(1000)
        ...
        FuseCountdownComponent.propDecorators = {
            eventDate: [{ type: i0.Input, args: ['eventDate',] }]
        };
    ...
    var FuseHighlightComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseHighlightComponent.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
        ...
        FuseHighlightComponent.propDecorators = {
            source: [{ type: i0.ContentChild, args: ['source',] }],
            lang: [{ type: i0.Input, args: ['lang',] }],
            path: [{ type: i0.Input, args: ['path',] }]
        };
    ...
    var FUSE_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR = {
        ...
        useExisting: i0.forwardRef(function () { return FuseMaterialColorPickerComponent; }),
        multi: true
    };
    ...
    var FuseNavigationService = /** @class */ (function () {
        ...
        function FuseNavigationService() {
            this._registry = {};
            // Set the defaults
            this.onItemCollapsed = new rxjs.Subject();
            this.onItemCollapseToggled = new rxjs.Subject();
            // Set the private defaults
            this._currentNavigationKey = null;
            this._onNavigationChanged = new rxjs.BehaviorSubject(null);
            this._onNavigationRegistered = new rxjs.BehaviorSubject(null);
            this._onNavigationUnregistered = new rxjs.BehaviorSubject(null);
            this._onNavigationItemAdded = new rxjs.BehaviorSubject(null);
            this._onNavigationItemUpdated = new rxjs.BehaviorSubject(null);
            this._onNavigationItemRemoved = new rxjs.BehaviorSubject(null);
        }
        ...
        FuseNavigationService.prototype.getFlatNavigation = function (navigation, flatNavigation) {
            ...
            try {
                ...
                try {
                    if (navigation_1_1 && !navigation_1_1.done && (_a = navigation_1.return))
                        _a.call(navigation_1);
                }
                finally {
                    if (e_1)
                        throw e_1.error;
        ...
        FuseNavigationService.prototype.getNavigationItem = function (id, navigation) {
            ...
            try {
                ...
                try {
                    if (navigation_2_1 && !navigation_2_1.done && (_a = navigation_2.return))
                        _a.call(navigation_2);
                }
                finally {
                    if (e_2)
                        throw e_2.error;
        ...
        FuseNavigationService.prototype.getNavigationItemParent = function (id, navigation, parent) {
            ...
            try {
                ...
                try {
                    if (navigation_3_1 && !navigation_3_1.done && (_a = navigation_3.return))
                        _a.call(navigation_3);
                }
                finally {
                    if (e_3)
                        throw e_3.error;
    ...
    var FuseNavigationComponent = /** @class */ (function () {
        ...
        FuseNavigationComponent.prototype.ngOnInit = function () {
            ...
            rxjs.merge(this._fuseNavigationService.onNavigationItemAdded, this._fuseNavigationService.onNavigationItemUpdated, this._fuseNavigationService.onNavigationItemRemoved).pipe(operators.takeUntil(this._unsubscribeAll))
                .subscribe(function () {
                // Mark for check
                _this._changeDetectorRef.markForCheck();
            });
        ...
        /** @nocollapse */
        FuseNavigationComponent.ctorParameters = function () {
            return [
    ...
    var FuseNavVerticalItemComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseNavVerticalItemComponent.ctorParameters = function () {
            return [
                { type: i0.ChangeDetectorRef },
                { type: FuseNavigationService }
            ];
    ...
    var FuseNavVerticalCollapsableComponent = /** @class */ (function () {
        ...
        FuseNavVerticalCollapsableComponent.prototype.ngOnInit = function () {
            ...
            this._router.events
                .pipe(operators.filter(function (event) { return event instanceof i1$4.NavigationEnd; }), operators.takeUntil(this._unsubscribeAll))
        ...
        /** @nocollapse */
        FuseNavVerticalCollapsableComponent.ctorParameters = function () {
            return [
                { type: i0.ChangeDetectorRef },
                { type: FuseNavigationService },
                { type: i1$4.Router }
    ...
    var FuseNavVerticalGroupComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseNavVerticalGroupComponent.ctorParameters = function () {
            return [
                { type: i0.ChangeDetectorRef },
                { type: FuseNavigationService }
            ];
    ...
    var FuseNavHorizontalCollapsableComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseNavHorizontalCollapsableComponent.ctorParameters = function () {
            return [
                { type: FuseConfigService }
            ];
        };
        FuseNavHorizontalCollapsableComponent.propDecorators = {
            classes: [{ type: i0.HostBinding, args: ['class',] }],
            item: [{ type: i0.Input }],
            open: [{ type: i0.HostListener, args: ['mouseenter',] }],
            close: [{ type: i0.HostListener, args: ['mouseleave',] }]
        };
    ...
    var FuseProgressBarService = /** @class */ (function () {
        ...
        FuseProgressBarService.prototype._init = function () {
            ...
            this._bufferValue = new rxjs.BehaviorSubject(0);
            this._mode = new rxjs.BehaviorSubject('indeterminate');
            this._value = new rxjs.BehaviorSubject(0);
            this._visible = new rxjs.BehaviorSubject(false);
            // Subscribe to the router events to show/hide the loading bar
            this._router.events
                .pipe(operators.filter(function (event) { return event instanceof i1$4.NavigationStart; }))
                .subscribe(function () {
                _this.show();
            });
            this._router.events
                .pipe(operators.filter(function (event) { return event instanceof i1$4.NavigationEnd || event instanceof i1$4.NavigationError || event instanceof i1$4.NavigationCancel; }))
                .subscribe(function () {
                _this.hide();
            });
        };
        ...
        /** @nocollapse */
        FuseProgressBarService.ctorParameters = function () {
            return [
                { type: i1$4.Router }
            ];
        };
        FuseProgressBarService.ngInjectableDef = i0.defineInjectable({ factory: function FuseProgressBarService_Factory() { return new FuseProgressBarService(i0.inject(i1$4.Router)); }, token: FuseProgressBarService, providedIn: "root" });
    ...
    var FuseProgressBarComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseProgressBarComponent.ctorParameters = function () {
            return [
    ...
    var FuseSearchBarComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseSearchBarComponent.ctorParameters = function () {
            return [
                { type: FuseConfigService }
            ];
        };
    ...
    var FuseShortcutsComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseShortcutsComponent.ctorParameters = function () {
            return [
        ...
        FuseShortcutsComponent.propDecorators = {
            navigation: [{ type: i0.Input }],
            searchInputField: [{ type: i0.ViewChild, args: ['searchInput',] }],
            shortcutsEl: [{ type: i0.ViewChild, args: ['shortcuts',] }]
        };
    ...
    var FuseSidebarComponent = /** @class */ (function () {
        ...
        function FuseSidebarComponent(_animationBuilder, _changeDetectorRef, _elementRef, _fuseConfigService, _fuseMatchMediaService, _fuseSidebarService, _mediaObserver, _renderer) {
            ...
            this.foldedWidth = 64;
            this.foldedChanged = new i0.EventEmitter();
            this.openedChanged = new i0.EventEmitter();
            this.opened = false;
            this.position = 'left';
        ...
        FuseSidebarComponent.prototype._showBackdrop = function () {
            ...
            this._player =
                this._animationBuilder
                    .build([
                    i1$3.animate('300ms ease', i1$3.style({ opacity: 1 }))
        ...
        FuseSidebarComponent.prototype._hideBackdrop = function () {
            ...
            this._player =
                this._animationBuilder
                    .build([
                    i1$3.animate('300ms ease', i1$3.style({ opacity: 0 }))
                ]).create(this._backdrop);
            // Play the animation
            this._player.play();
        ...
        /** @nocollapse */
        FuseSidebarComponent.ctorParameters = function () {
            return [
                { type: i1$3.AnimationBuilder },
                { type: i0.ChangeDetectorRef },
                { type: i0.ElementRef },
                { type: FuseConfigService },
                { type: FuseMatchMediaService },
        ...
        FuseSidebarComponent.propDecorators = {
            ...
            opened: [{ type: i0.HostBinding, args: ['class.open',] }],
            lockedOpen: [{ type: i0.Input }],
            isLockedOpen: [{ type: i0.HostBinding, args: ['class.locked-open',] }],
            foldedWidth: [{ type: i0.Input }],
            foldedAutoTriggerOnHover: [{ type: i0.Input }],
            unfolded: [{ type: i0.HostBinding, args: ['class.unfolded',] }],
            invisibleOverlay: [{ type: i0.Input }],
            foldedChanged: [{ type: i0.Output }],
            openedChanged: [{ type: i0.Output }],
            _animationsEnabled: [{ type: i0.HostBinding, args: ['class.animations-enabled',] }],
            folded: [{ type: i0.Input }],
    ...
    var FuseThemeOptionsComponent = /** @class */ (function () {
        ...
        FuseThemeOptionsComponent.prototype.ngOnInit = function () {
            ...
            this.form = this._formBuilder.group({
                colorTheme: new forms.FormControl(),
                customScrollbars: new forms.FormControl(),
                layout: this._formBuilder.group({
                    style: new forms.FormControl(),
                    width: new forms.FormControl(),
                    navbar: this._formBuilder.group({
                        primaryBackground: new forms.FormControl(),
                        secondaryBackground: new forms.FormControl(),
                        folded: new forms.FormControl(),
                        hidden: new forms.FormControl(),
                        position: new forms.FormControl(),
                        variant: new forms.FormControl()
                    }),
                    toolbar: this._formBuilder.group({
                        background: new forms.FormControl(),
                        customBackgroundColor: new forms.FormControl(),
                        hidden: new forms.FormControl(),
                        position: new forms.FormControl()
                    }),
        ...
        /** @nocollapse */
        FuseThemeOptionsComponent.ctorParameters = function () {
            return [
        ...
        FuseThemeOptionsComponent.propDecorators = {
            barClosed: [{ type: i0.HostBinding, args: ['class.bar-closed',] }]
        };
    ...
    var FuseWidgetToggleDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseWidgetToggleDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef }
            ];
        };
    ...
    var FuseWidgetComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseWidgetComponent.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: i0.Renderer2 }
            ];
        ...
        FuseWidgetComponent.propDecorators = {
            flipped: [{ type: i0.HostBinding, args: ['class.flipped',] }],
            toggleButtons: [{ type: i0.ContentChildren, args: [FuseWidgetToggleDirective, { descendants: true },] }]
        };
    ...
    var FuseTranslationLoaderService = /** @class */ (function () {
        ...
        /** @nocollapse */
        FuseTranslationLoaderService.ctorParameters = function () {
            return [
                { type: i1$2.TranslateService }
            ];
        };
        FuseTranslationLoaderService.ngInjectableDef = i0.defineInjectable({ factory: function FuseTranslationLoaderService_Factory() { return new FuseTranslationLoaderService(i0.inject(i1$2.TranslateService)); }, token: FuseTranslationLoaderService, providedIn: "root" });
    ...
    var FuseSplashScreenService = /** @class */ (function () {
        ...
        FuseSplashScreenService.prototype._init = function () {
            ...
            if (this.splashScreenEl) {
                ...
                this._router.events
                    .pipe(operators.filter((function (event) { return event instanceof i1$4.NavigationEnd; })), operators.take(1))
                    .subscribe(function () {
                    setTimeout(function () {
                        _this.hide();
                    });
        ...
        FuseSplashScreenService.prototype.show = function () {
            ...
            this.player =
                this._animationBuilder
                    ...
                    i1$3.animate('400ms ease', i1$3.style({ opacity: '1' }))
        ...
        FuseSplashScreenService.prototype.hide = function () {
            ...
            this.player =
                this._animationBuilder
                    ...
                    i1$3.animate('400ms ease', i1$3.style({
                        opacity: '0',
                        zIndex: '-10'
                    }))
                ]).create(this.splashScreenEl);
        ...
        /** @nocollapse */
        FuseSplashScreenService.ctorParameters = function () {
            return [
                { type: i1$3.AnimationBuilder },
                { type: undefined, decorators: [{ type: i0.Inject, args: [i2.DOCUMENT,] }] },
                { type: i1$4.Router }
        ...
        FuseSplashScreenService.ngInjectableDef = i0.defineInjectable({ factory: function FuseSplashScreenService_Factory() { return new FuseSplashScreenService(i0.inject(i1$3.AnimationBuilder), i0.inject(i2.DOCUMENT), i0.inject(i1$4.Router)); }, token: FuseSplashScreenService, providedIn: "root" });
    ...
    exports.ɵr = fuseAnimations;
    exports.ɵl = FuseCountdownComponent;
    exports.ɵm = FuseDemoContentComponent;
    exports.ɵn = FuseDemoSidebarComponent;
    exports.ɵo = FuseHighlightComponent;
    exports.ɵp = FUSE_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR;
    exports.ɵq = FuseMaterialColorPickerComponent;
    exports.ɵx = FuseNavHorizontalCollapsableComponent;
    exports.ɵw = FuseNavHorizontalItemComponent;
    exports.ɵs = FuseNavigationComponent;
    exports.ɵv = FuseNavVerticalCollapsableComponent;
    exports.ɵt = FuseNavVerticalGroupComponent;
    exports.ɵu = FuseNavVerticalItemComponent;
    exports.ɵy = FuseProgressBarComponent;
    exports.ɵz = FuseProgressBarService;
    exports.ɵba = FuseSearchBarComponent;
    exports.ɵbb = FuseShortcutsComponent;
    exports.ɵbc = FuseSidebarComponent;
    exports.ɵbd = FuseThemeOptionsComponent;
    exports.ɵbf = FuseWidgetToggleDirective;
    exports.ɵbe = FuseWidgetComponent;
    exports.ɵa = FuseDirectivesModule;
    exports.ɵb = FuseIfOnDomDirective;
    exports.ɵc = FuseInnerScrollDirective;
    exports.ɵd = FuseMatSidenavHelperDirective;
    exports.ɵe = FuseMatSidenavTogglerDirective;
    exports.ɵf = FuseMatSidenavHelperService;
    exports.ɵk = CamelCaseToDashPipe;
    exports.ɵj = FilterPipe;
    exports.ɵh = GetByIdPipe;
    exports.ɵi = HtmlToPlaintextPipe;
    exports.ɵg = KeysPipe;
    exports.FuseModule = FuseModule;
    exports.FuseSharedModule = FuseSharedModule;
    exports.fuseAnimations = fuseAnimations;
